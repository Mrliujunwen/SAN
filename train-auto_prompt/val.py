...
"""
# from testdataset import testMyDataset
def parse_args():
...
def main():
    ...
    model = auto_prompt.TransNuSeg(img_size=256,in_chans=3)
    model = model.cuda()
    ...
    val_loader = testMyDataset(dir_path='./data/histology',
                              json_path=r"converted_dict.json")
    with torch.no_grad():
