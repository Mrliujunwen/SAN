...
def draw_loss(train_loss,val_loss,test_loss_clus,test_loss_nors,test_loss_segs,now):
    plt.subplot(2, 1, 2)
    plt.plot(train_loss, label='Training Loss')
    plt.plot(val_loss, label='Validation Loss')
    plt.plot(test_loss_clus, label='clus Loss')
    plt.plot(test_loss_nors, label='nors Loss')
    plt.plot(test_loss_segs, label='segs Loss')
