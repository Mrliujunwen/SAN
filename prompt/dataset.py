...
class MyDataset(Dataset):
    ...
    '''
    def __init__(self,dir_path,json_path,transform = None,in_chan = 3):
        ...
        self.data_lists = list(self.data_info.keys())
        self.label_lists = [self.data_info[k][0] for k in self.data_lists]  # Assuming each key has a single label
