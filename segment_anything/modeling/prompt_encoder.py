...
class PromptEncoder(nn.Module):
    def __init__(
        ...
        """
        Encodes prompts for input to SAM's masks decoder.
    ...
    def forward(
        ...
        Arguments:
          ...
          masks (torch.Tensor or none): masks1 to embed

        Returns:
          torch.Tensor: sparse embeddings for the points and boxes, with shape
            BxNx(embed_dim), where N is determined by the number of input points
            and boxes.
          torch.Tensor: dense embeddings for the masks1, in the shape
