...
class SamOnnxModel(nn.Module):
    ...
    It combines the prompt encoder, masks decoder, and masks postprocessing of Sam,
    ...
    def select_masks(
        ...
        # Determine if we should return the multiclick masks or not from the number of points.
